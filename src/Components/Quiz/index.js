  ...
  nextQuestion = () => {
    if (this.state.idQuestion === this.state.maxQuestions - 1) {
      ...
      this.setState((prevState) => ({
        ...
        userAnswers: [...prevState.userAnswers, this.state.userAnswer],
      }));
    } else {
      this.setState((prevState) => ({
      ...
      return (
        <p
          ...
          className={`answerOptions ${
            this.state.userAnswer === option ? "selectedOption" : null
          }`}
        >
          {option}
        </p>
    ...
    return !this.state.displayResults ? (
      <>
        <Levels
          ...
          level={this.state.levels[this.state.quizLevel]}
      ...
      <Results
        ...
        loadSameLevel={this.loadSameLevel}
        datas={this.storedDataRef.current}
