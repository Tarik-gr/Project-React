    ...
    <main className="container bg-light landingPage">
      <div className="row h-100">
        <div
          ...
          onMouseOver={changeLeftBackground}
          onMouseOut={RemoveLeftBackground}
          className="col leftCol"
        >
          <Link to="/signup" className="btn btn-block btn-lg btn-light">
            Inscription
          </Link>
        </div>
        <div
          ...
          onMouseOver={changeRightBackground}
          onMouseOut={RemoveRightBackground}
          className="col rightCol"
        >
          <Link to="/login" className="btn btn-block btn-light btn-lg">
            Connexion
          </Link>
        </div>
      </div>
