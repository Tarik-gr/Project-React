...
const Signup = (props) => {
  ...
  const btnLogin = dataForLogin.pseudo !== "" &&
    dataForLogin.email !== "" &&
    dataForLogin.password !== "" &&
    dataForLogin.password === dataForLogin.confirmPassword && (
          ...
          <form action="" onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <input
                type="password"
                onChange={handleChange}
                value={dataForLogin.confirmPassword}
                className="form-control"
                id="confirmPassword"
              />
            </div>
